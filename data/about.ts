export const ABOUT_DATA = {
  ...
  buttons: {
    resume: { label: "Resume", link: "#" },
    contact: { label: "Contact", link: "https://www.linkedin.com/in/himanshu-g27/" },
  },

  socials: [
    { icon: "github", link: "https://github.com/HimanshuGupta586" },
    { icon: "linkedin", link: "https://www.linkedin.com/in/himanshu-g27/" },
    { icon: "mail", link: "mailto:programmerhg001@email.com" },
  ],
};
